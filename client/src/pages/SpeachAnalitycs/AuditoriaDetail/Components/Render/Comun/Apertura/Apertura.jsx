        ...
        <div className="p-4 bg-white border rounded-lg shadow-sm">
          ...
          <div className="text-gray-700 mb-3 space-y-1">
            <p>
              ...
              <span
                className={
                  item.evaluacion.apertura.resultado === "Aprobado"
                    ? "text-green-600"
                    : "text-red-600"
                }
              >
            ...
            <p>
              ...
              {item.evaluacion.apertura.cumplimiento?.toFixed(2)}%
            </p>
          </div>
          <div className="bg-gray-50 border rounded p-3 space-y-2">
            {Object.entries(item.evaluacion.apertura.criterios || {}).map(
